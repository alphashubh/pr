...
public class ApplyEducationLoanTest {
	...
	public void addUserDetailTest() {
		...
		ApplyEducationLoan loanObj =new ApplyEducationLoan(100000.00,"2017-02-21",2,150000.00,20000.00,
   ...
   assertTrue(true);
	...
	public void insertLoan() {
		...
		ApplyEducationLoan loanObj =new ApplyEducationLoan(107800.00,"2017-07-01",5,15000.00,20000.00,
