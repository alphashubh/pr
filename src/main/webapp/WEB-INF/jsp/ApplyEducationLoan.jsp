...
<table>
    ...
    <tr>
        <td>Loan Amount :</td>
        <td><form:input path="eduLoanAmount" placeholder="Loan Amount" maxlength="15"/></td>
    ...
    <tr>
     ...
     <tr>
        ...
        <td><form:input path="fatherAnnualIncome" placeholder="Annual Income" maxlength="15"/></td>
    ...
    <table>
     ...
     <tr>
        <td>Course Fee :</td>
        <td><form:input path="courseFee" placeholder="Course Fee" maxlength="15"/></td>
