...
public class TestApplyHomeLoan {
	...
	public void testInsertHomeLoanDetails() {
		...
		try {
			ApplyHomeLoan h1 = new ApplyHomeLoan(54534534, 4, 265464, "cts", "VP", 4, 3, userDetails);
			ApplyHomeLoan h2 = new ApplyHomeLoan(5345434, 3, 87232, "tcs", "Trainer", 4, 3, userDetails);
	...
	public void testUpdateLoanDetails() throws ParseException {
		...
		ApplyHomeLoan h2 = new ApplyHomeLoan(5345434, 5,87232, "cts", "associate", 4, 3);
